    ...
    return (
      ...
      <footer className="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
        ...
        <div className="t-center p-l-15 p-r-15">
          <a href="#">
            <img className="h-size2" src={ require('./../../../../vendor/modules/frontend/images/icons/paypal.png') } alt="IMG-PAYPAL" />
          </a>
          <a href="#">
            <img className="h-size2" src={ require('./../../../../vendor/modules/frontend/images/icons/visa.png') } alt="IMG-VISA" />
          </a>
          <a href="#">
            <img className="h-size2" src={ require('./../../../../vendor/modules/frontend/images/icons/mastercard.png') } alt="IMG-MASTERCARD" />
          </a>
          <a href="#">
            <img className="h-size2" src={ require('./../../../../vendor/modules/frontend/images/icons/express.png') } alt="IMG-EXPRESS" />
          </a>
          <a href="#">
            <img className="h-size2" src={ require('./../../../../vendor/modules/frontend/images/icons/discover.png') } alt="IMG-DISCOVER" />
          </a>
